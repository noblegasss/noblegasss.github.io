...
Check the code for this paper: [https://github.com/noblegasss/Exploration-of-Mixture-g-Priors-BMA-Variable-Selection-in-Generalized-Linear-Model-with-Microarray-D](https://github.com/noblegasss/Exploration-of-Mixture-g-Priors-BMA-Variable-Selection-in-Generalized-Linear-Model-with-Microarray-D)
...
suppose we have another $$\mathbf{X}_{\mathcal{M}'} \text{ contains } \rho_\mathcal{M}$$, such that $$\mathcal{C}(\mathbf{X}_{\mathcal{M}'}) = \mathcal{C}(\mathbf{X}_{\mathcal{M}})$$. 
...
$$\text{Figure 2: Beta Binomial(1,1) model prior genes included}$$
